...
It does NOT create rooms/properties — those must already exist (run
`python -m src.database.migrate_all` first, and load your room master data
however this project normally does — e.g. `scripts/clean_and_load.py` /
`excel_import.py`, or a hand-seeded `rooms` table). This script only reads
the existing `rooms` + `properties` tables and fills tenants/tenancies/
payments/finance data around them.
...
from src.database.models import (
    Property, Room, Tenant, Tenancy, RentSchedule, Payment, CheckoutRecord,
...
MALE_FIRST_NAMES = [
    ...
    "Vishal", "Gautam", "Harsh", "Jayant", "Kartik", "Lokesh2", "Madhav", "Neeraj",
    "Om", "Pankaj", "Rajat", "Sagar", "Tejas", "Umesh", "Vivek", "Aniket",
    "Bhavesh", "Chetan", "Dhruv", "Eshaan", "Girish", "Hemant", "Indraneel", "Jatin",
    "Kiran2", "Lalit", "Manish", "Nishant", "Omkar", "Pratik", "Rajesh2", "Satish",
    "Tushar", "Utkarsh", "Vaibhav", "Yogesh", "Abhinav", "Balaji", "Chandan2",
]
