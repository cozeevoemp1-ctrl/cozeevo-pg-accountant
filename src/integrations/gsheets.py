...
def _add_tenant_sync(
    ...
    try:
        ...
        # First month: Rent Due = rent + deposit (deposit includes maintenance)
        first_month_due = agreed_rent + deposit
        adv_balance = first_month_due - advance_amount
