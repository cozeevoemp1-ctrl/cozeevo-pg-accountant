...
async def _help(entities: dict, ctx: CallerContext, session: AsyncSession) -> str:
    ...
    return (
        ...
        "  _report 2026_ — yearly view\n\n"
        "*Tenants*\n"
        "  _add tenant_ — new check-in\n"
        "  _checkout Raj_ — exit process\n"
        "  _Raj gave notice_ — record notice\n"
        "  _Raj balance_ — payment history\n"
        "  _transfer Raj to 305_ — room change\n\n"
        "*Rooms*\n"
        "  _vacant rooms_ — all empty\n"
        "  _empty beds in thor_ — building filter\n"
        "  _female empty beds_ — gender match\n\n"
        "*Other*\n"
        "  _log expense_ — record expense\n"
