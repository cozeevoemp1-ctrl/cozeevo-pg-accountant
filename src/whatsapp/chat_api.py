...
def _detect_mid_flow_breakout(message: str, pending_intent: str, skip_new_intent: bool = False) -> Optional[str]:
    ...
    if pending_intent in ("ADD_TENANT_STEP", "RECORD_CHECKOUT", "CONFIRM_PAYMENT_LOG", "COLLECT_RENT_STEP", "LOG_EXPENSE_STEP", "CONFIRM_PAYMENT_ALLOC", "UPDATE_TENANT_NOTES_STEP", "ADD_CONTACT_STEP", "FORM_EXTRACT_CONFIRM", "COLLECT_DOCS", "CONFIRM_ADD_TENANT", "CHECKOUT_FORM_CONFIRM", "COLLECT_RECEIPT", "QUERY_RECEIPT_STEP"):
