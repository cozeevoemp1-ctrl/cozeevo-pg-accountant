            ...
            <div class="result" id="result">
                ...
                <div style="margin-bottom: 12px;">
                    <div style="font-size: 12px; color: #666; margin-bottom: 8px;">
                        <span id="whatsappStatus"></span>
                    </div>
                </div>
                <div style="font-size: 13px; font-weight: 600; margin-bottom: 8px; color: #333;">Onboarding Link:</div>
                <div class="result-link" id="resultLink"></div>
                <button class="copy-btn" onclick="copyToClipboard()">📋 Copy & Send Manually</button>
            </div>
        </div>
            ...
            document.getElementById('sessionForm').addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if (data.whatsapp_sent) {
                        statusEl.innerHTML = '✅ Link sent via WhatsApp';
                        statusEl.style.color = '#28a745';
                    } else {
                        statusEl.innerHTML = '⚠️ WhatsApp send failed — copy link below to send manually';
